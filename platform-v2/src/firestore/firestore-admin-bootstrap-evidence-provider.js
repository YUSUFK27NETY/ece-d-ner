...
const ADMIN_BOOTSTRAP_EVIDENCE_SETTING_ID = "admin-bootstrap-readiness";
...
function fail(label) {
    throw new TypeError(
        `Firestore admin bootstrap evidence ${label} geçersiz.`
    );
}
...
function createFirestoreAdminBootstrapEvidenceProvider({ db }) {
